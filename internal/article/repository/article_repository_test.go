...
func TestCreateArticle(t *testing.T) {
	...
	mock.ExpectQuery(regexp.QuoteMeta(
		`INSERT INTO "articles" ("title","url","bookmark_count","created_at","updated_at","deleted_at") VALUES ($1,$2,$3,$4,$5,$6) RETURNING "id"`)).
		WillReturnRows(rows)
	mock.ExpectCommit()
...
func TestGetArticle(t *testing.T) {
	...
	rows := sqlmock.NewRows([]string{"id", "title", "url", "bookmark_count", "created_at", "updated_at", "deleted_at"}).
		AddRow(1, testArticle.Title, testArticle.Url, testArticle.BookmarkCount, time.Now(), time.Now(), nil)
...
func TestListArticles(t *testing.T) {
	...
	rows := sqlmock.NewRows([]string{"id", "title", "url", "bookmark_count", "created_at", "updated_at", "deleted_at"}).
		AddRow(1, testArticle1.Title, testArticle1.Url, testArticle1.BookmarkCount, time.Now(), time.Now(), nil).
		AddRow(2, testArticle2.Title, testArticle2.Url, testArticle2.BookmarkCount, time.Now(), time.Now(), nil)
