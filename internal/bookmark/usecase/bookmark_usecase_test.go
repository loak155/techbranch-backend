...
func TestCreateBookmark(t *testing.T) {
	...
	testCases := []struct {
		...
		{
			name: "Failed to increament bookmark count",
			args: args{
				ctx:      context.Background(),
				bookmark: reqBookmark,
			},
		...
		},
		{
			...
			buildStubs: func(repo *mock.MockIBookmarkRepository, mockArticleClient *mock.MockArticleServiceClient) {
				...
				mockArticleClient.EXPECT().IncrementBookmarksCountCompensate(gomock.Any(), gomock.Any()).Return(resSuccessIncrementBookmarksCount, nil)
			},
			checkResponse: func(t *testing.T, resBookmark domain.Bookmark, err error) {
				assert.Error(t, err)
				assert.Equal(t, resBookmark, domain.Bookmark{})
...
func TestDeleteBookmark(t *testing.T) {
	...
	testCases := []struct {
		...
		{
			name: "Failed to decrement bookmark count",
			args: args{
				ctx:      context.Background(),
				bookmark: reqBookmark,
			},
		...
		},
		{
			...
			buildStubs: func(repo *mock.MockIBookmarkRepository, mockArticleClient *mock.MockArticleServiceClient) {
				...
				mockArticleClient.EXPECT().DecrementBookmarksCountCompensate(gomock.Any(), gomock.Any()).Return(resSuccessDecrementBookmarksCount, nil)
			},
			checkResponse: func(t *testing.T, res bool, err error) {
				assert.Error(t, err)
				assert.False(t, res)
