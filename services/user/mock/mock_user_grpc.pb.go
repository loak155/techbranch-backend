...
import (
	...
	proto "github.com/loak155/techbranch-backend/services/user/proto"
...
func (m *MockUserServiceClient) CreateUser(ctx context.Context, in *proto.CreateUserRequest, opts ...grpc.CallOption) (*proto.CreateUserResponse, error) {
	m.ctrl.T.Helper()
...
func (m *MockUserServiceClient) GetUserByEmail(ctx context.Context, in *proto.GetUserByEmailRequest, opts ...grpc.CallOption) (*proto.GetUserByEmailResponse, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
	...
	ret0, _ := ret[0].(*proto.GetUserByEmailResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockUserServiceClient) ListUsers(ctx context.Context, in *proto.ListUsersRequest, opts ...grpc.CallOption) (*proto.ListUsersResponse, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
...
// CreateUser mocks base method.
func (m *MockUserServiceServer) CreateUser(arg0 context.Context, arg1 *proto.CreateUserRequest) (*proto.CreateUserResponse, error) {
	m.ctrl.T.Helper()
...
// DeleteUser mocks base method.
func (m *MockUserServiceServer) DeleteUser(arg0 context.Context, arg1 *proto.DeleteUserRequest) (*proto.DeleteUserResponse, error) {
	m.ctrl.T.Helper()
...
// GetUser mocks base method.
func (m *MockUserServiceServer) GetUser(arg0 context.Context, arg1 *proto.GetUserRequest) (*proto.GetUserResponse, error) {
	m.ctrl.T.Helper()
...
// GetUserByEmail mocks base method.
func (m *MockUserServiceServer) GetUserByEmail(arg0 context.Context, arg1 *proto.GetUserByEmailRequest) (*proto.GetUserByEmailResponse, error) {
	m.ctrl.T.Helper()
...
// ListUsers mocks base method.
func (m *MockUserServiceServer) ListUsers(arg0 context.Context, arg1 *proto.ListUsersRequest) (*proto.ListUsersResponse, error) {
	m.ctrl.T.Helper()
...
// UpdateUser mocks base method.
func (m *MockUserServiceServer) UpdateUser(arg0 context.Context, arg1 *proto.UpdateUserRequest) (*proto.UpdateUserResponse, error) {
	m.ctrl.T.Helper()
