...
func RegisterBookmarkServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server BookmarkServiceServer) error {
	...
	mux.Handle("POST", pattern_BookmarkService_CreateBookmark_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/techbranch.bookmark.BookmarkService/CreateBookmark", runtime.WithHTTPPathPattern("/api/v1/bookmarks"))
		if err != nil {
	...
	mux.Handle("GET", pattern_BookmarkService_GetBookmarkCountByArticleID_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/techbranch.bookmark.BookmarkService/GetBookmarkCountByArticleID", runtime.WithHTTPPathPattern("/api/v1/articles/{article_id}/bookmarks/count"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_BookmarkService_ListBookmarksByUserID_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/techbranch.bookmark.BookmarkService/ListBookmarksByUserID", runtime.WithHTTPPathPattern("/api/v1/users/{user_id}/bookmarks"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_BookmarkService_ListBookmarksByArticleID_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/techbranch.bookmark.BookmarkService/ListBookmarksByArticleID", runtime.WithHTTPPathPattern("/api/v1/articles/{article_id}/bookmarks"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("DELETE", pattern_BookmarkService_DeleteBookmark_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/techbranch.bookmark.BookmarkService/DeleteBookmark", runtime.WithHTTPPathPattern("/api/v1/bookmarks"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterBookmarkServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client BookmarkServiceClient) error {
	...
	mux.Handle("POST", pattern_BookmarkService_CreateBookmark_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/techbranch.bookmark.BookmarkService/CreateBookmark", runtime.WithHTTPPathPattern("/api/v1/bookmarks"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_BookmarkService_GetBookmarkCountByArticleID_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/techbranch.bookmark.BookmarkService/GetBookmarkCountByArticleID", runtime.WithHTTPPathPattern("/api/v1/articles/{article_id}/bookmarks/count"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_BookmarkService_ListBookmarksByUserID_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/techbranch.bookmark.BookmarkService/ListBookmarksByUserID", runtime.WithHTTPPathPattern("/api/v1/users/{user_id}/bookmarks"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_BookmarkService_ListBookmarksByArticleID_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/techbranch.bookmark.BookmarkService/ListBookmarksByArticleID", runtime.WithHTTPPathPattern("/api/v1/articles/{article_id}/bookmarks"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("DELETE", pattern_BookmarkService_DeleteBookmark_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/techbranch.bookmark.BookmarkService/DeleteBookmark", runtime.WithHTTPPathPattern("/api/v1/bookmarks"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_BookmarkService_CreateBookmark_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"api", "v1", "bookmarks"}, ""))

	pattern_BookmarkService_GetBookmarkCountByArticleID_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 2, 4, 2, 5}, []string{"api", "v1", "articles", "article_id", "bookmarks", "count"}, ""))

	pattern_BookmarkService_ListBookmarksByUserID_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 2, 4}, []string{"api", "v1", "users", "user_id", "bookmarks"}, ""))

	pattern_BookmarkService_ListBookmarksByArticleID_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 2, 4}, []string{"api", "v1", "articles", "article_id", "bookmarks"}, ""))

	pattern_BookmarkService_DeleteBookmark_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"api", "v1", "bookmarks"}, ""))
)
