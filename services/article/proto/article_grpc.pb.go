...
const (
	ArticleService_CreateArticle_FullMethodName        = "/techbranch.article.ArticleService/CreateArticle"
	ArticleService_GetArticle_FullMethodName           = "/techbranch.article.ArticleService/GetArticle"
	ArticleService_ListArticles_FullMethodName         = "/techbranch.article.ArticleService/ListArticles"
	ArticleService_UpdateArticle_FullMethodName        = "/techbranch.article.ArticleService/UpdateArticle"
	ArticleService_DeleteArticle_FullMethodName        = "/techbranch.article.ArticleService/DeleteArticle"
	ArticleService_GetArticleCount_FullMethodName      = "/techbranch.article.ArticleService/GetArticleCount"
	ArticleService_GetBookmarkedArticle_FullMethodName = "/techbranch.article.ArticleService/GetBookmarkedArticle"
)
...
type ArticleServiceClient interface {
	...
	GetBookmarkedArticle(ctx context.Context, in *GetBookmarkedArticleRequest, opts ...grpc.CallOption) (*GetBookmarkedArticleResponse, error)
}
...
func (c *articleServiceClient) GetBookmarkedArticle(ctx context.Context, in *GetBookmarkedArticleRequest, opts ...grpc.CallOption) (*GetBookmarkedArticleResponse, error) {
	out := new(GetBookmarkedArticleResponse)
	err := c.cc.Invoke(ctx, ArticleService_GetBookmarkedArticle_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ArticleServiceServer interface {
	...
	GetBookmarkedArticle(context.Context, *GetBookmarkedArticleRequest) (*GetBookmarkedArticleResponse, error)
...
func (UnimplementedArticleServiceServer) GetBookmarkedArticle(context.Context, *GetBookmarkedArticleRequest) (*GetBookmarkedArticleResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetBookmarkedArticle not implemented")
}
...
func _ArticleService_GetBookmarkedArticle_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetBookmarkedArticleRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ArticleServiceServer).GetBookmarkedArticle(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ArticleService_GetBookmarkedArticle_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ArticleServiceServer).GetBookmarkedArticle(ctx, req.(*GetBookmarkedArticleRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ArticleService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "techbranch.article.ArticleService",
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetBookmarkedArticle",
			Handler:    _ArticleService_GetBookmarkedArticle_Handler,
		},
	},
